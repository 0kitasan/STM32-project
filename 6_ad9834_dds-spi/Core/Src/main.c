...
//  }
  ...
  ad9834_send(0xC000);
  // Exit Reset
  ad9834_send(0x2000|0x0038);
  // ad9834_send(0x2000|0x0002);
  // 解除复位，并输出三角波
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  //ad9834_send(0x2100);
	  //send_test(0x2100);
	  //send_test(0b11111111);
	  __NOP();
	  send_test(0b10101010);
	  //send_test(0b00110000);
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
}
